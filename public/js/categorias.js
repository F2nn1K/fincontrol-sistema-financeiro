...
function inicializarCategorias() {
  console.log('🚀 Inicializando módulo de categorias');
  ...
  console.log('🔍 Botão salvar específico:', {
    existe: !!botaoSalvar,
    id: botaoSalvar?.id,
...
async function carregarCategorias() {
  try {
    ...
    console.log(`Categorias carregadas - Entrada: ${categoriasEntradaList.length} Saída: ${categoriasSaidaList.length}`);
...
function novaCategoria(tipo = 'entrada') {
  console.log('🆕 Nova categoria chamada, tipo:', tipo);
  limparFormulario();
...
async function salvarCategoria() {
  console.log('🚀 Função salvarCategoria chamada');
  ...
  try {
    ...
    console.log('✅ Validação passou, nome:', categoriaNome.value.trim());
    ...
    if (categoriaId && categoriaId.value) {
      ...
      console.log('🔄 Atualizando categoria existente, ID:', categoriaId.value);
      ...
      console.log('✅ Categoria criada:', resultado);
...
function configurarEventListeners() {
  console.log('🔧 Configurando event listeners de categorias...');
